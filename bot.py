...
def get_main_btns():
    ...
    builder.row(InlineKeyboardButton(text="Məni Qrupa Əlavə Et ➕", url=f"https://t.me/{(bot.get_me_sync() if hasattr(bot, 'get_me_sync') else 'Miss_Flower_bot')}?startgroup=true"))
    builder.row(
...
async def main_manager(message: Message):
    ...
    # STİKER VƏ GİF SİLMƏ (DÜZƏLDİLDİ)
