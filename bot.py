...
# ==========================================================
# 👋 START MESAJI (PEŞƏKAR GÖRÜNÜŞ VƏ DÜYİMLƏR)
# ==========================================================
...
# ==========================================================
# 👮 ADMİN KOMANDALARI (MÜTLƏQ REPLİ İLƏ İŞLƏYİR)
# ==========================================================
...
async def ban_handler(message: types.Message):
    ...
    except: await message.answer("❌ Xəta: Botun səlahiyyəti yetmir.")
...
async def warn_handler(message: types.Message):
    ...
    if cnt >= 3:
        ...
        await message.answer(f"⚠️ {message.reply_to_message.from_user.first_name} xəbərdarlıq aldı: {cnt}/3")
...
# ==========================================================
# 🎲 ƏYLƏNCƏ KOMANDALARI (YENİ ƏLAVƏLƏR)
# ==========================================================
...
async def slot_handler(message: types.Message):
    await message.answer_dice(emoji="🎰")
...
# ==========================================================
# 📊 REYTİNQ CƏDVƏLİ (AZƏRBAYCAN DİLİNDƏ)
# ==========================================================
...
# ==========================================================
# 🚫 STİKER BLOKU VƏ MESAJ SAYĞACI
# ==========================================================

@dp.message(Command("stiker"))
async def stiker_set(message: types.Message, command: CommandObject):
    if not await is_admin(message.chat.id, message.from_user.id): return
    if command.args == "off":
...
async def main_handler(message: types.Message):
    ...
    # Adı qeyd et və mesaj sayını artır
    ...
    if not (message.text and message.text.startswith("/")):
        for k in ["günlük", "həftəlik", "ümumi"]:
    ...
    st_status = db_cursor.fetchone()
    if st_status and st_status[0] == 1 and (message.sticker or message.animation):
